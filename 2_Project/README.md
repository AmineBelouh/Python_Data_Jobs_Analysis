...
![2_Skill_Demand_Graph](images/2_Skill_Demand.png)

## 2. How are in-demand skills trending for Data Analysts?

View my notebook with detailed steps here:    [3_Skills_Trend](3_Skills_Trend.ipynb) 

![3_Skills_Trend_Graph](images/3_Skills_Trend.png)

## 3. How well do jobs and skills pay for Data Analysts?

View my notebook with detailed steps here:    [4_Salary_Analysis](4_Salary_Analysis.ipynb) 

![4_Salary_Analysis_1_Graph](images/4_Salary_Analysis_1.png)

![4_Salary_Analysis_2_Graph](images/4_Salary_Analysis_2.png)

## 4. What are the most optimal skills to learn for Data Analysts?

View my notebook with detailed steps here:    [5_Optimal_Skills](5_Optimal_Skills.ipynb) 

![5_Optimal_Skills_Graph](images/5_Optimal_Skills.png)
